...
interface SuperAdminPlanEditProps {
    plan: Plan;
}

export default function SuperAdminPlanEdit({ plan }: SuperAdminPlanEditProps) {
    ...
    const handleNameChange = (value: string) => {
        setFormData({
            ...formData,
            name: value,
            slug: formData.slug === plan.slug ? generateSlug(value) : formData.slug,
        });
    };
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.put(`/super-admin/plans/${plan.id}`, submitData, {
            onSuccess: () => {
                setProcessing(false);
            },
            onError: (errors) => {
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">Update subscription plan details and features</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-3">
                        ...
                        <div className="space-y-6">
                            ...
                            <Card>
                                ...
                                <CardContent className="space-y-3">
                                    ...
                                    <Link href={`/super-admin/plans/${plan.id}`} className="block">
